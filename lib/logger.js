...
module.exports.http = (function() {
    ...
    var gray   = Logger.getColor.bind(Logger, 'gray');
    var green  = Logger.getColor.bind(Logger, 'green');
    var yellow = Logger.getColor.bind(Logger, 'yellow');
    var red    = Logger.getColor.bind(Logger, 'red');

    return {
        200:function(msg) {
            return [green('200'), gray(msg)].join(' ');
        },
        304:function(msg) {
            return [yellow('304'), gray(msg)].join(' ');
        },
        404:function(msg) {
            return [red('404'), gray(msg)].join(' ');
        }
    };
})();
