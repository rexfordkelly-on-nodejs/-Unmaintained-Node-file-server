...
function Directory() {
  ...
  this.combine = function(type, name, cb) {
    var root = this.get('root');
    var location = path.join(root, name);
    var files = fs.readdirSync(root).filter(filter(type));
  ...
  this.combineScripts = this.combine.bind(this, 'js');
  this.combineStyles = this.combine.bind(this, 'css');
